...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        ...
        AddressBookStorage addressBookStorage = new JsonAddressBookStorage(userPrefs.getAnimalCatalogFilePath());
     ...
     */
    private AnimalModel initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
    ...
    public void stop() {
        ...
        try {
            storage.saveUserPrefs(animalModel.getUserPrefs());
        } catch (IOException e) {
